...
#include "Modules/IOModules/Video/OpenKinect/OpenKinect.h"
...
#include "Modules/VisionModules/MPIFaceDetector/MPIFaceDetector.h"
#include "Modules/VisionModules/ARToolKitPlusModule/ARToolKitPlusModule.h"
...
InitModules(Kernel & k)
{
    ...
    k.AddClass("OpenKinect", &OpenKinect::Create, "Source/Modules/IOModules/Video/OpenKinect/");
    ...
    k.AddClass("MPIFaceDetector", &MPIFaceDetector::Create , "Source/Modules/VisionModules/MPIFaceDetector/");
    k.AddClass("ARToolKitPlusModule", &ARToolKitPlusModule::Create, "Source/Modules/VisionModules/ARToolKitPlusModule/");
